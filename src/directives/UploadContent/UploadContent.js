...
export default {
  ...
  methods: {
    ...
    contentUploaded(contentObj, mode = null) {
  ...
  computed: {
    ...
    isHideEnterText() {
      return this.hideMethods && includes(this.hideMethods, 'enter_text');
    },
    isHideUploadNew() {
      return this.hideMethods && includes(this.hideMethods, 'upload_new');
    },
    isHideUploadLink() {
      return this.hideMethods && includes(this.hideMethods, 'upload_link');
    },
    isHideChooseUploaded() {
      return this.hideMethods && includes(this.hideMethods, 'choose_uploaded');
    }
  },
  data() {
    return {
